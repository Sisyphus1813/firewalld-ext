...
- firewalld is the primary performance bottleneck of this project:
	...
	- complete reloads are necessary to apply updated ipsets
...
Please follow Python best practices and ensure your changes don’t break existing functionality. This project relies on [Ruff](https://astral.sh/ruff) for formatting and linting, and [Pyrefly](https://pyrefly.org/) for type checking.
